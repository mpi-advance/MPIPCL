...
//---------------------------------------------------------------------------------
/** @brief This function takes information about the starting buffer
...
/** @brief This function takes information about the starting buffer, external partitions,
 and communication target and populates the supplied MPIP_Request object
 with information necessary for it to setup the reciever side
...
/** @brief This function marks the partition with the given id
...
*@param [in]  int tag,    The base tag to be used by the MPIPCL request
*@param [in]  MPI_Comm comm, The MPI_communicator context to be used by the request. 
*@param [in]  MPI_Info info MPI_info object used to define the internal behavior
 of the request object. 
*@param [in, out] MPIP_Request* request request object to be populated. 
*/
int MPIP_Pready(int partition, MPIP_Request* request);

/** @brief This function marks the partitions with the given ids between partition_low
...
/** @brief This function marks the partitions with ids listed in array_of_partitions 
...
/** @brief This function calls a synchronization function based on the information 
...
/** @brief Resets the completion and ready status of all partitions and internal messages
...
/** @brief This functions sets the number of internal creates to a static value determined
* by option.
...
/** @brief This function allows one side of the communication to determine the number of 
*internal messages. 
...
/** @brief This function is run by the background thread, 
...
/** @brief This function attempts to send the given partition. 
...
// remap functions
/** @brief This function maps which internal messages are necessary for 

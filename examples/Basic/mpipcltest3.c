 ...
 * This program tests MPIA_Startall, MPIA_Pready_range, and
...
int main(int argc, char* argv[])
{
    ...
    { /* sender */
        ...
        {
            rc = MPIA_Pready_range(0, nparts - 1, &req[i]);
            assert(rc == MPI_SUCCESS);
        }
    ...
    { /* receiver */
        ...
        rc = MPIA_Start(&req[0]);
        assert(rc == MPI_SUCCESS);
        rc = MPIA_Wait(&req[0], MPI_STATUS_IGNORE);
        assert(rc == MPI_SUCCESS);
